...
async def send_message(
    ...
    t2i_instruction = (
        ...
        "If the user asks to DETECT, LOCATE, FIND, or SEGMENT objects in an image (e.g. 'detect cats', 'find all people', 'locate heads and hands'), "
        "you MUST output the detection results in JSON format with class labels: "
